...
<div class="container-xxl py-5">
    <div class="container">
        ...
        <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
            ...
            include 'auth/php/config.php';
            $sql = "SELECT v.*, c.logo FROM tbl_vacancy v INNER JOIN tbl_company c ON v.uuid = c.uuid WHERE v.job_nature = 'Part Time' ORDER BY v.uid DESC LIMIT 10";
                            ...
                            <div class="row g-4">
                                <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                    ...
                                    <div class="text-start ps-5">
                                        ...
                                        <span class="text-truncate location-truncate me-3"><i class="fa fa-map-marker-alt text-primary me-2"></i><?php echo $row['location']; ?></span>
