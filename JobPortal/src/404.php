        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>Discover the extraordinary, where innovation meets passion and excellence.</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link text-white-50" href="i">Home</a>
                    <a class="btn btn-link text-white-50" href="about.php">About Us</a>
                    <a class="btn btn-link text-white-50" href="category.php">Job Category</a>
                    <a class="btn btn-link text-white-50" href="job-detail.php">Job Details</a>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        All Right Reserved &copy; <a class="border-bottom" href="https://www.facebook.com/onebugallon">ONE Bugallone</a> 
                    </div>
                    <div class="col-md-6 text-center text-md-end">
                        <div class="footer-menu">
                            Designed By &copy; <a class="border-bottom" href="https://www.facebook.com/yparraguirre2001">Developer</a>
                        </div>
                    </div>
                </div>
            </div>
