    ...
    <div id="page-content-wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
            <div class="d-flex align-items-center">
                ...
                <h2 class="fs-2 m-0">Add Company</h2>
            </div>
        </nav>
        <!-- /Top navigation bar -->
        ...
        <div class="container mt-5">
            ...
            <form action="add-company.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="company_detail" class="form-label">Detail</label>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="company_email" required>
                </div>
                <div class="mb-3">
                    <label for="contact" class="form-label">Contact</label>
                    <input type="text" class="form-control" id="contact" name="company_contact" required>
                </div>
                <div class="mb-3">
                    <label for="owner" class="form-label">Owner</label>
                    <input type="text" class="form-control" id="owner" name="company_owner" required>
                </div>
                <div class="mb-3">
                    <label for="logo" class="form-label">Logo</label>
                    <input type="file" class="form-control" id="logo" name="logo" required>
                </div>
                <button type="submit" class="btn btn-primary"><i class="fas fa-user-plus"></i> Add Company</button>
