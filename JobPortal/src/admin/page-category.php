...
<div class="d-flex" id="wrapper">
            ...
            <div class="row my-5">
                <div class="col">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            <!-- Add User button -->
                            <a href="page-add-category.php" class="btn btn-primary"><i class="fas fa-user-plus"></i> Add Category</a>
                        </div>
                        <div class="d-flex">
                            <!-- Search form -->
                    ...
                    <table class="table bg-white rounded shadow-sm table-hover">
                        ...
                        if (isset($_GET['search'])) {
                            ...
                            $query = "SELECT * FROM tbl_category WHERE 
                                    date LIKE '%$search%' OR 
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<button class='btn btn-danger btn-sm ms-1' onclick='deleteCategory(" . $row['uid'] . ")'><i class='fas fa-trash-alt'></i></button>";
                            echo "</td>";
                            echo "</tr>";
                        }
    ...
    function editCategory(uid) {
        ...
        window.location.href = "page-edit-category.php?uid=" + uid;
    }
    ...
    function clearSearch() {
        var searchInput = document.querySelector('input[date="search"]');
