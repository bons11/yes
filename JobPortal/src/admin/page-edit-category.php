        ...
        <div class="container mt-5">
            ...
            <form action="edit-category.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($category['date']); ?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($category['description']); ?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="status" class="form-label" id="status" name="status" value="<?php echo htmlspecialchars($category['status']); ?>">Status</label>
                    <select class="form-select" id="status" name="status" required>
                        <option value="available" <?php if ($category['status'] === 'available') echo htmlspecialchars('selected'); ?>>Available</option>
                        <option value="unavailable" <?php if ($category['status'] === 'unavailable') echo htmlspecialchars('selected'); ?> >Unavailable</option>
                    </select>
                </div>
